...
public final class DefaultGameConfig {
    ...
    public static String[] resolveArgs(final String[] args) {
        if (args.length > 0) {
            return args;
        }

        System.out.println("Nenhum argumento informado. Carregando tabuleiro padrao.");
        return DEFAULT_CONFIG.trim().split("\\s+");
    }
}
